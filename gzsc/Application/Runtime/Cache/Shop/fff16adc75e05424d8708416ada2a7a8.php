     ...
     <div class="panel-body">
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd">   
         ...
         <td class=" ">
            <a href="/gzsc/index.php/Shop/Service/homedecorationedit/id/<?php echo ($val["id"]); ?>">修改</a> <br>
            <a href="/gzsc/index.php/Shop/Service/homedecorationdel/id/<?php echo ($val["id"]); ?>">删除</a> <br> 
            <a href="/gzsc/index.php/Shop/Service/homedecorationfile/id/<?php echo ($val["id"]); ?>">图片</a> <br> 
         </td> 
