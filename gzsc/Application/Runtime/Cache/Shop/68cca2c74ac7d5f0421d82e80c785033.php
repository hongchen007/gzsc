...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 家居装修图片 </button> 
      </div>  

      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Shop/Service/addhomedecorationfile/id/<?php echo ($id); ?>"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-plus"></i>添加图片 </button></a> 
      </div> 

      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Shop/Service/homedecoration"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-reply"></i> fa-reply</button></a> 
      </div>
  ...
  <div class="panel-body"> 
   ...
   <div class="aaaaa" style="width:100%;display:flex;justify-content:flex-start;flex-wrap: wrap;">
    <?php if(is_array($info)): foreach($info as $key=>$val): ?><div class="aaaaaa" style="display:flex ;flex-direction: column;margin-right:10px;">
              <a href="" class="qwer">
                  <img alt="" src="/gzsc/Public/Uploads/<?php echo ($val['file']); ?>" class="qwert" style="width:200px;height:200px;">
              </a>
              <p style="margin-top:10px;text-align:center;">
                <a href="/gzsc/index.php/Shop/Service/edithomedecorationfile/id/<?php echo ($val["id"]); ?>">修改</a> | 
                <a href="/gzsc/index.php/Shop/Service/delhomedecorationfile/id/<?php echo ($val["id"]); ?>">删除</a>  
              </p>
