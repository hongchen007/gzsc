...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 折扣活动修改 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Activity/doeditdiscount');?>" novalidate="novalidate"> 

    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">打折商品名称</label> 
      <div class="col-lg-10" style="margin-top:0.5%;"> 
        <?php echo ($info["good_name"]); ?>
      ...
      <div class="form-group">
          ...
          <div class="col-lg-10"> 
              <select class="form-control m-bot15" name="discount" id="discount">  
                <?php if(is_array($info1)): foreach($info1 as $key=>$val): ?><option value="<?php echo ($val["des"]); ?>" <?php if($info['good_attr_discount'] == $val['des']): ?>selected<?php endif; ?> ><?php echo ($val["des"]); ?></option><?php endforeach; endif; ?>
              </select>
          </div>
      </div>
