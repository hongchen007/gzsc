     ...
     <div class="panel-body">
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd">   
         ...
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['driving_lience_pic']); ?>" style="height:100px;"></td>
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['lience_num_pic']); ?>" style="height:100px;"></td>
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['register_pic']); ?>" style="height:100px;"></td>
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['bill_pic']); ?>" style="height:100px;"></td>
         ...
         <td class=" ">
            <a href="/gzsc/index.php/Shop/Service/secondhandcaredit/id/<?php echo ($val["id"]); ?>">详情</a> <br>
            <a href="/gzsc/index.php/Shop/Service/secondhandcardel/id/<?php echo ($val["id"]); ?>">删除</a> <br> 
            <a href="/gzsc/index.php/Shop/Service/secondhandcarfile/id/<?php echo ($val["id"]); ?>">图片</a> <br> 
         </td> 
