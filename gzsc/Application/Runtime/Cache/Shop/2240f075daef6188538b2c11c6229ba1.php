      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 7%;" aria-label="Points: activate to sort column ascending">标题描述</th>
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd">   
         ...
         <td class=" ">
            <a href="/gzsc/index.php/Shop/Service/truckrendedit/id/<?php echo ($val["id"]); ?>">修改</a> <br>
            <a href="/gzsc/index.php/Shop/Service/truckrenddel/id/<?php echo ($val["id"]); ?>">删除</a> <br> 
            <a href="/gzsc/index.php/Shop/Service/truckrendfile/id/<?php echo ($val["id"]); ?>">图片</a> <br> 
         </td> 
