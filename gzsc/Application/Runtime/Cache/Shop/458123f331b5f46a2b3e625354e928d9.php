        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <?php if($_SESSION['info']['user_grade']== 2 || $_SESSION['info']['user_grade']== 4): ?><li class="menu-list"><a href=""><i class="fa fa-th"></i> <span>商铺管理</span></a>
                    ...
                    <li class="menu-list"><a href=""><i class="fa fa-cogs"></i></i> <span>广告管理</span></a>
                        <ul class="sub-menu-list">
                            <li><a href="<?php echo U('Pics/index');?>">所有广告</a></li>
                        </ul>
                    </li><?php endif; ?>
  ...
  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Service/secondhandcardoedit');?>" novalidate="novalidate">  
     ...
     <?php if($info["state"] == 0): ?><div class="form-group ">
        <label for="QQ" class="control-label col-lg-2">快递单当前的状态</label> 
        <div class="col-lg-10" style="margin-top:0.5%;"> 
          <?php echo ($info["message"]); ?>
        </div> 
       </div><?php endif; ?>

     <?php if($info["state"] == 1): ?><div class="form-group ">
        <label for="QQ" class="control-label col-lg-2">快递单当前的状态</label> 
        <div class="col-lg-10" style="margin-top:0.5%;"> 
     ...
     <?php if($info["state"] == 2): ?><div class="form-group ">
        <label for="QQ" class="control-label col-lg-2">快递单当前的状态</label> 
        <div class="col-lg-10" style="margin-top:0.5%;"> 
          货物寄送过程出了问题
        </div> 
     ...
     <?php if($info["state"] == 3): ?><div class="form-group ">
        <label for="QQ" class="control-label col-lg-2">快递单当前的状态</label> 
        <div class="col-lg-10" style="margin-top:0.5%;"> 
          收件人已签收
        </div> 
     ...
     <?php if($info["state"] == 4): ?><div class="form-group ">
        <label for="QQ" class="control-label col-lg-2">快递单当前的状态</label> 
        <div class="col-lg-10" style="margin-top:0.5%;"> 
          货物由于用户拒签、超区等原因退回，而且发件人已经签收
        </div> 
       </div><?php endif; ?>

     <?php if($info["state"] == 5): ?><div class="form-group ">
        <label for="QQ" class="control-label col-lg-2">快递单当前的状态</label> 
        <div class="col-lg-10" style="margin-top:0.5%;"> 
          快递正在进行同城派件
        </div> 
     ...
     <?php if($info["state"] == 6): ?><div class="form-group ">
        <label for="QQ" class="control-label col-lg-2">快递单当前的状态</label> 
        <div class="col-lg-10" style="margin-top:0.5%;"> 
          货物正处于退回发件人的途中
        </div> 
      ...
      <?php if(is_array($info["data"])): foreach($info["data"] as $key=>$val): ?><div class="form-group "> 
          <label for="QQ" class="control-label col-lg-2"><?php echo ($val["time"]); ?></label> 
          <div class="col-lg-10" style="margin-top:0.5%;"><?php echo ($val["context"]); ?></div> 
