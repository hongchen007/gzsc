...
<!--          <td class=" ">
         ...
         <td class=" ">
            <?php if($val["states"] == 1): ?><span style="color:green;"> 待审核
            <?php elseif($val["states"] == 2): ?> <span style="color:blue;">通过审核
            <?php elseif($val["states"] == 3): ?> <span style="color:red;">已禁用</span><?php endif; ?>
         </td>
         <td class=" ">
            <a href="/gzsc/index.php/Shop/Service/companyedit/id/<?php echo ($val["id"]); ?>">详情</a> <br>
            <a href="/gzsc/index.php/Shop/Service/companydel/id/<?php echo ($val["id"]); ?>">删除</a> <br> 
            <a href="/gzsc/index.php/Shop/Service/companyfile/id/<?php echo ($val["id"]); ?>">图片</a> <br> 
         </td> 
