...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 修改货车出租 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Service/truckrenddoedit');?>" novalidate="novalidate">   

    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">品牌</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="brand" name="brand" type="text" value="<?php echo ($info["brand"]); ?>" /> 
    ...
    <div class="form-group "> 
      ...
      <div class="col-lg-10"> 
       <input class="form-control " id="car_num" name="car_num" type="text" value="<?php echo ($info["car_num"]); ?>" /> 
      </div> 
     </div> 
    ...
    <div class="form-group "> 
      ...
      <div class="col-lg-10"> 
       <input class="form-control " id="date_for_production" name="date_for_production" type="text" value="<?php echo ($info["date_for_production"]); ?>" /> 
      </div> 
     </div> 
