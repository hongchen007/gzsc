...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 折扣活动添加 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Activity/insert');?>" novalidate="novalidate"> 

      <div class="form-group">
          <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">打折商品</label>
          <div class="col-lg-10"> 
              <select class="form-control m-bot15" name="good_id" id="good_id"> 
                <option value="">--请选择--</option>  
                <?php if(is_array($info)): foreach($info as $key=>$val): ?><option value="<?php echo ($val["id"]); ?>" ><?php echo ($val["good_name"]); ?></option><?php endforeach; endif; ?>
              </select>
          </div>
      </div>
      ...
      <div class="form-group">
          <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">折扣</label>
          <div class="col-lg-10"> 
              <select class="form-control m-bot15" name="discount" id="discount">  
                <option value="">--请选择--</option> 
                <?php if(is_array($info1)): foreach($info1 as $key=>$val): ?><option value="<?php echo ($val["discount"]); ?>"><?php echo ($val["des"]); ?></option><?php endforeach; endif; ?>
              </select>
          </div>
      </div>
