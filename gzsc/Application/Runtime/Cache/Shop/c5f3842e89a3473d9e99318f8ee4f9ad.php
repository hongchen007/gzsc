            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <?php if($_SESSION['info']['user_grade']== 2 || $_SESSION['info']['user_grade']== 4): ?><li class="menu-list"><a href=""><i class="fa fa-th"></i> <span>商铺管理</span></a>
                        <ul class="sub-menu-list">
                            <li><a href="<?php echo U('Store/index');?>">基本信息</a></li>
                            <li><a href="<?php echo U('Store/storedata');?>">基本资料</a></li>
                        </ul>
                    </li>
        ...
        <title>后台-添加物流信息</title>
         ...
         <div class="clearfix" style="margin-left:10px;"> 
          ...
          <div class="btn-group pull-right"> 
           <a href="/gzsc/index.php/Shop/Order/index"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-reply"></i> fa-reply</button></a> 
          </div>
         </div> 
