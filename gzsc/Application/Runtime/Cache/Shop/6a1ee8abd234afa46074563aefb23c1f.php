...
<!--       <div class="btn-group pull-right"> 
     ...
     <div class="panel-body">
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 8%;" aria-label="First Name">订单人</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">订单号</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">收货人</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">收货地址</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">收货人电话</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">订单时间</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">订单价格</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">应收金钱</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">订单状态</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">物流公司</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">物流编号</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 8%;" aria-label="Points: activate to sort column ascending">操作</th>
        </tr> 
       </thead>
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd"> 
         ...
         <td class=" ">
          ...
          <?php if($val["order_grade"] == 2): ?><span style="color:green">已支付<a href="/gzsc/index.php/Shop/Order/deliver/id/<?php echo ($val["id"]); ?>">（点击发货）</a></span><?php endif; ?>
         ...
         <td class=" ">
          <a href="/gzsc/index.php/Shop/Order/detail/id/<?php echo ($val["id"]); ?>">详细信息</a> <br>
          <?php if($val["order_grade"] == 2 || $val["order_grade"] == 3 || $val["order_grade"] == 4 || $val["order_grade"] == 5): ?><a href="/gzsc/index.php/Shop/Order/wuliuedit/id/<?php echo ($val["id"]); ?>">快递</a> |
            <a href="/gzsc/index.php/Shop/Order/wuliu/id/<?php echo ($val["id"]); ?>">物流</a><?php endif; ?>
         </td> 
