     ...
     <div class="panel-body">
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       ...
       <?php if(is_array($UserInfo)): foreach($UserInfo as $key=>$val): ?><tr class="odd">   
         ...
         <td class=" ">
          <?php if($val["store_notice_state"] == 1): ?><a href="/gzsc/index.php/Shop/Storenotice/edit/id/<?php echo ($val["id"]); ?>">修改</a>  | 
            <a href="/gzsc/index.php/Shop/Storenotice/del/id/<?php echo ($val["id"]); ?>">删除</a> | 
            <a href="/gzsc/index.php/Shop/Storenotice/stop/id/<?php echo ($val["id"]); ?>">禁用</a>
          <?php else: ?>
            <a href="/gzsc/index.php/Shop/Storenotice/edit/id/<?php echo ($val["id"]); ?>">修改</a> | 
            <a href="/gzsc/index.php/Shop/Storenotice/del/id/<?php echo ($val["id"]); ?>">删除</a>  |  
            <a href="/gzsc/index.php/Shop/Storenotice/start/id/<?php echo ($val["id"]); ?>">启用</a><?php endif; ?>
         </td> 
