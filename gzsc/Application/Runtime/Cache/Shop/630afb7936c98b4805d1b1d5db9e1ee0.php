...
<!-- 
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       ...
       <tbody role="alert" aria-live="polite" aria-relevant="all"> 
        ...
        <?php if(empty($UserInfo['user_store_headerpic']) == true): ?><td class=" ">请点击修改完善信息</td> 
        <?php else: ?>
          <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($UserInfo['user_store_headerpic']); ?>" style="width:100px;"></td><?php endif; ?>
        ...
        <?php else: ?>
         ...
         <td class=" ">
          <?php if($UserInfo["user_store_evaluate"] == 5): ?>五星<?php endif; ?>
          <?php if($UserInfo["user_store_evaluate"] == 4): ?>四星<?php endif; ?>
          <?php if($UserInfo["user_store_evaluate"] == 3): ?>三星<?php endif; ?>
          <?php if($UserInfo["user_store_evaluate"] == 2): ?>二星<?php endif; ?>
          <?php if($UserInfo["user_store_evaluate"] == 1): ?>一星<?php endif; ?>
         </td> 
         <td class=" "><?php echo ($UserInfo['user_store_star']); ?>星级</td>
         <td class=" "><?php echo ($UserInfo['user_phone']); ?></td> 
         <td class=" "><a href="/gzsc/index.php/Shop/Store/edit/id/<?php echo ($UserInfo["id"]); ?>">修改</a></td> 
         </td> 
        </tr> 
       </tbody>
      </table>
