...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="clearfix" style="margin-left:10px;"> 
    <div class="btn-group"> 
     <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 添加医疗图片 </button> 
    </div>  
   </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Service/doaddmedialservicefile');?>" novalidate="novalidate"> 

     <div class="form-group "> 
      <label for="state" class="control-label col-lg-2">医疗图片</label> 
      <div class="col-lg-10"> 
       <input id="file_pic" name="file_pic[]" type="file" multiple="multiple" /> 
       <input id="medial_service_id" name="medial_service_id" type="hidden" value="<?php echo ($id); ?>" /> 
      </div> 
     </div>
