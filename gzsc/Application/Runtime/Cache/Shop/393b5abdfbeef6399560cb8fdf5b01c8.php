   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      ...
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 商铺商品 &gt; <?php echo ($good_name); ?>详细信息 </button> 
      </div> 

      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Shop/Store/addattr/good_name/<?php echo ($good_name); ?>/id/<?php echo ($id); ?>"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-plus"></i>添加属性 </button></a> 
      </div> 

      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Shop/Store/good"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-reply"></i> fa-reply</button></a> 
      </div>
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Points: activate to sort column ascending">商品原价</th>
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd"> 
         ...
         <td class=" ">
            <a href="/gzsc/index.php/Shop/Store/editattr/good_attr_id/<?php echo ($val["id"]); ?>">修改</a> | 
            <a href="/gzsc/index.php/Shop/Store/delattr/good_attr_id/<?php echo ($val["id"]); ?>">删除</a> |
            <a href="/gzsc/index.php/Shop/Store/pic/good_attr_id/<?php echo ($val["id"]); ?>">图片</a> 
         </td> 
