...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 货车出租图片 </button> 
      </div>  

      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Shop/Service/addtruckrendfile/id/<?php echo ($id); ?>"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-plus"></i>添加图片 </button></a> 
      </div> 

      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Shop/Service/truckrend"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-reply"></i> fa-reply</button></a> 
      </div>
   ...
   <div class="aaaaa" style="width:100%;display:flex;justify-content:flex-start;flex-wrap: wrap;">
    <?php if(is_array($info)): foreach($info as $key=>$val): ?><div class="aaaaaa" style="display:flex ;flex-direction: column;margin-right:10px;">
              ...
              <p style="margin-top:10px;text-align:center;">
                <a href="/gzsc/index.php/Shop/Service/edittruckrendfile/id/<?php echo ($val["id"]); ?>">修改</a> | 
                <a href="/gzsc/index.php/Shop/Service/deltruckrendfile/id/<?php echo ($val["id"]); ?>">删除</a>  
              </p>
