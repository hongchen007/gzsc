...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 商铺基本资料 </button> 
      </div> 
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Last Name: activate to sort column ascending">商铺名称</th>
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Edit: activate to sort column ascending">商户抽成百分比</th>
       ...
       <tbody role="alert" aria-live="polite" aria-relevant="all"> 
        ...
        <tr class="odd"> 
         ...
         <td class="  sorting_1">
            <?php if($val["user_grade"] == 2): ?><span style="color:green;">商户正常</span>
            <?php elseif($val["user_grade"] == 3): ?> <span style="color:#ccc;">商户禁用</span>
            <?php elseif($val["user_grade"] == 4): ?> <span style="color:red;">商户为激活</span><?php endif; ?>
         </td> 
         ...
         <td class=" ">
            <a href="/gzsc/index.php/Shop/Store/storedataedit/id/<?php echo ($val["id"]); ?>">修改</a>
         </td> 
        </tr> 
