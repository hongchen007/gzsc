...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      ...
      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Shop/Store/addpic/id/<?php echo ($good_attr_info["id"]); ?>"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-plus"></i>添加图片 </button></a> 
      </div> 

      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Shop/Store/detail/id/<?php echo ($good_attr_info['good_id']); ?>"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-reply"></i> fa-reply</button></a> 
      </div>
          ...
          <div class="media blog-cmnt">
              ...
              <div class="media-body">
                  ...
                  <p style="margin-top:10px;">
                    <a href="/gzsc/index.php/Shop/Store/editpic/id/<?php echo ($val["id"]); ?>">修改</a> | 
                    <a href="/gzsc/index.php/Shop/Store/delpic/id/<?php echo ($val["id"]); ?>">删除</a>  
                  </p>
              </div>
          </div>
