     ...
     <div class="panel-body">
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       ...
       <?php if(is_array($UserInfo)): foreach($UserInfo as $key=>$val): ?><tr class="odd"> 
         ...
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['adsserve_pic']); ?>" style="width:100px;"></td>  
         <td class="  sorting_1">
         ...
         <td class=" ">
            <a href="/gzsc/index.php/Shop/Adsserve/detail/id/<?php echo ($val["id"]); ?>">详情</a> <br>
            <a href="/gzsc/index.php/Shop/Adsserve/edit/id/<?php echo ($val["id"]); ?>">修改</a> <br>
            <a href="/gzsc/index.php/Shop/Adsserve/del/id/<?php echo ($val["id"]); ?>">删除</a><br>
         </td> 
