...
<!--          <td class=" ">
         ...
         <td class=" ">
            <a href="/gzsc/index.php/Shop/Store/editgood/id/<?php echo ($val["id"]); ?>">修改</a>|
            <a href="/gzsc/index.php/Shop/Store/del/id/<?php echo ($val["id"]); ?>">删除</a>|
            <a href="/gzsc/index.php/Shop/Store/detail/id/<?php echo ($val["id"]); ?>">详细信息</a>
         </td> 
