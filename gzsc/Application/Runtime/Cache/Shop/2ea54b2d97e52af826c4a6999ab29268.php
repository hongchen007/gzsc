...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 修改招聘信息 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Service/inforservicedoedit');?>" novalidate="novalidate">   
    ...
    <div class="form-group "> 
      ...
      <div class="col-lg-10"> 
       <input class="form-control " id="seat" name="seat" type="text" value="<?php echo ($info["seat"]); ?>" /> 
      </div> 
     </div> 
    ...
    <div class="form-group "> 
      ...
      <div class="col-lg-10"> 
       <textarea rows="6" class="form-control" name="job_req" ><?php echo ($info["job_req"]); ?></textarea>
      </div> 
     </div> 
    ...
    <div class="form-group "> 
      ...
      <div class="col-lg-10"> 
       <input class="form-control " id="payment" name="payment" type="text" value="<?php echo ($info["payment"]); ?>" /> 
      </div> 
     </div> 
