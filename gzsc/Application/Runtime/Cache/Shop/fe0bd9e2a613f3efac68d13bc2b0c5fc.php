...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="clearfix" style="margin-left:10px;"> 
    <div class="btn-group"> 
     <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 修改家居装修图片 </button> 
    </div>  
   </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Service/doedithomedecorationfile');?>" novalidate="novalidate"> 

     <div class="form-group "> 
      <label for="state" class="control-label col-lg-2" >原图片</label> 
      <div class="col-lg-10"> 
        <img src="/gzsc/Public/Uploads/<?php echo ($info["file"]); ?>" style="width:600px;">
      </div> 
     </div> 
