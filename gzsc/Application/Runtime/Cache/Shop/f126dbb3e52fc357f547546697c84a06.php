        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <?php if($_SESSION['info']['user_grade']== 2 || $_SESSION['info']['user_grade']== 4): ?><li class="menu-list"><a href=""><i class="fa fa-th"></i> <span>商铺管理</span></a>
                    ...
                    <li class="menu-list"><a href=""><i class="fa fa-th-large"></i> <span>电商管理</span></a>
                        <ul class="sub-menu-list">
...
<!--        <form class="searchform" action="index.html" method="post">
        ...
        <title>后台-添加物流信息</title>
         ...
         <div class="clearfix" style="margin-left:10px;"> 
          <div class="btn-group"> 
           <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 添加物流信息 </button> 
          </div>  
         </div> 
  ...
  <div class="panel-body"> 
   <div class="form"> 
    ...
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">物流</label> 
      <div class="col-lg-10"> 
        <div id="select">
            <input class="form-control" type="text" name="order_wuliucompany" id="order_wuliucompany">
            <div class="hidehaha">
                <ul class="li_flex">
                  <li>百世汇通</li>
                  <li>顺丰</li>
    ...
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">订单号</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="order_wuliunum" name="order_wuliunum" type="text" /> 
...
<script src="/gzsc/Public/Admin/js/dashboard-chart-init.js"></script>
 ...
 <script type="text/javascript">
    $(function () {
        $(".hidehaha").hide();
        $("#order_wuliucompany").focus(function () {
            $(".hidehaha").slideDown("slow");
            $("li").css("cursor","pointer");
            // onmouseover="this.style.cursor='hand'";
        });
        $("#order_wuliucompany").blur(function () {
