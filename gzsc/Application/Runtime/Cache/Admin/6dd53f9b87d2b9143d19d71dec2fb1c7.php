...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 修改商铺信息 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Store/doedit');?>" novalidate="novalidate"> 

    
     <div class="form-group "> 
      <label for="state" class="control-label col-lg-2">添加修改商铺图片</label> 
      <div class="col-lg-10"> 
    ...
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">添加修改商铺名称</label> 
      <div class="col-lg-10"> 
    ...
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">添加修改商铺地址</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="user_store_name" name="user_store_address" type="text" value="<?php echo ($info["user_store_address"]); ?>" />
      </div> 
     </div> 

    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">添加修改商铺电话</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="user_phone" name="user_phone" type="text" value="<?php echo ($info["user_phone"]); ?>" />
