...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 浏览用户 </button> 
      </div> 
      <div class="btn-group pull-right"> 
       <a href="<?php echo U('User/insert_user');?>"><button id="editable-sample_new" class="btn btn-primary"> Add New <i class="fa fa-plus"></i> </button></a> 
     ...
     <div class="panel-body">
        <form class="form-inline" role="form" action="<?php echo U('User/index_user');?>" method="get" />
     ...
     <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Last Name: activate to sort column ascending">电话</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Last Name: activate to sort column ascending">性别</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Points: activate to sort column ascending">添加时间</th>
       ...
       <?php if(is_array($UserInfo)): foreach($UserInfo as $key=>$val): ?><tr class="odd"> 
         ...
         <td class="  sorting_1">
            <?php if($val["user_grade"] == 5): ?><span style="color:green;"> 用户正常</span>
            <?php elseif($val["user_grade"] == 6): ?> <span style="color:red;">用户禁用</span><?php endif; ?>
         </td> 
         <td class=" "><?php echo ($val["user_phone"]); ?></td> 
         <td class="  sorting_1">
            <?php if($val["user_sex"] == 1): ?><span style="color:blue;">男</span>
            <?php elseif($val["user_sex"] == 0): ?> <span style="color:green;">女</span>
            <?php elseif($val["user_sex"] == 2): ?> <span style="color:green;">不详</span><?php endif; ?>  
         </td> 
         <td class=" "><?php echo ($val["user_add_time"]); ?></td> 
         <td class=" ">
          <?php if($val["user_grade"] == 5): ?><a href="/gzsc/index.php/Admin/User/edit_user/id/<?php echo ($val["id"]); ?>">修改</a>  | 
            <a href="/gzsc/index.php/Admin/User/del_user/id/<?php echo ($val["id"]); ?>">删除</a> | 
            <a href="/gzsc/index.php/Admin/User/stop_user/id/<?php echo ($val["id"]); ?>">禁用</a>
          <?php else: ?>
            <a href="/gzsc/index.php/Admin/User/edit_user/id/<?php echo ($val["id"]); ?>">修改</a> | 
            <a href="/gzsc/index.php/Admin/User/del_user/id/<?php echo ($val["id"]); ?>">删除</a>  |  
            <a href="/gzsc/index.php/Admin/User/start_user/id/<?php echo ($val["id"]); ?>">启用</a><?php endif; ?>
         </td> 
