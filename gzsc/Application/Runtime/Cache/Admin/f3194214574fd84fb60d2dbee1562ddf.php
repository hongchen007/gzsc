...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 商铺商品 </button> 
      </div> 
<!--       <div class="btn-group pull-right"> 
     ...
     <div class="panel-body">
        <form class="form-inline" role="form" action="<?php echo U('Store/good');?>" method="get" />
          
          <div class="form-group">
              <input class="form-control" id="exampleInputEmail2" value="<?php echo ($_GET['user_store_name']); ?>" name="user_store_name" placeholder="搜索商店名" type="text">
          </div>
          ...
          <div class="form-group">类别：
            <select class="form-control m-bot15" name="cate_id" >
              ...
              <?php if(is_array($list)): foreach($list as $key=>$row): ?><option value="<?php echo ($row['id']); ?>"><?php echo ($row['cate_name']); ?></option><?php endforeach; endif; ?>
            </select>
          </div>
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 5%;" aria-label="First Name">商店名</th>
         <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 5%;" aria-label="First Name">商品ID</th>
         <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 5%;" aria-label="First Name">商品名</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Points: activate to sort column ascending">商品类别</th>
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd"> 
         ...
         <td class=" ">
            <a href="/gzsc/index.php/Admin/Store/editgood/id/<?php echo ($val["id"]); ?>">修改</a>|
            <a href="/gzsc/index.php/Admin/Store/del/id/<?php echo ($val["id"]); ?>">删除</a>|
            <a href="/gzsc/index.php/Admin/Store/detail/id/<?php echo ($val["id"]); ?>">详细信息</a>
         </td> 
