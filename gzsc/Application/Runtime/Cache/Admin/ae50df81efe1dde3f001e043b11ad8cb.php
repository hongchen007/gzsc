    ...
    <div class="form-signin">
        ...
        <h1 class="sign-title">商户登录</h1>
            <ul class="classify">
                ...
                <li class="classify_B level" a="1">
                    <a href="<?php echo U('Login/index1');?>">
                        <span style="color:#688AC2;">商户登录</span>
                    </a>
                </li>
            </ul>
        ...
        <div class="sty">
            <div class="login-wrap">
                ...
                验证码:<img src="/gzsc/index.php/Admin/Login/verify" style="width:60%;height:30%;margin-left:10%;" onclick="this.src='/gzsc/index.php/Admin/Login/verify?id='+Math.random();">
...
<script type="text/javascript">
    $("#btn").click(function(){
        ...
        var URL="/gzsc/index.php/Admin/Login";
        var name=$("#name").val();
        var pwd=$("#pwd").val();
        var code=$("#code").val();
           ...
           success: function(data){
                if(data == 1){
                   ...
                   alert("手机号不存在");
                    ...
                    window.location.href="/gzsc/index.php/Admin/Index/index";
                }
           }
        });
