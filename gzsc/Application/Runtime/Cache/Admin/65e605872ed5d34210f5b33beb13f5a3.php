      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Edit: activate to sort column ascending">抽成百分比</th>
       ...
       <?php if(is_array($UserInfo)): foreach($UserInfo as $key=>$val): ?><tr class="odd"> 
         ...
         <td class="  sorting_1">
            ...
            <?php elseif($val["user_grade"] == 3): ?> <span style="color:#ccc;">商户禁用</span>
            <?php elseif($val["user_grade"] == 4): ?> <span style="color:red;">商户未激活</span><?php endif; ?>
         </td>  
         ...
         <td class=" "><?php echo ($val["user_store_percent"]); ?>%</td> 
         <td class=" ">
          <?php if($val["user_grade"] == 2): ?><a href="/gzsc/index.php/Admin/User/edit/id/<?php echo ($val["id"]); ?>">修改</a> |
            <a href="/gzsc/index.php/Admin/User/del/id/<?php echo ($val["id"]); ?>">删除</a>|
            <a href="/gzsc/index.php/Admin/User/stop/id/<?php echo ($val["id"]); ?>">禁用</a>|
            <a href="/gzsc/index.php/Admin/User/shopinfo/id/<?php echo ($val["id"]); ?>">查看</a>
          <?php elseif($val["user_grade"] == 3): ?>
            <a href="/gzsc/index.php/Admin/User/edit/id/<?php echo ($val["id"]); ?>">修改</a>|
            <a href="/gzsc/index.php/Admin/User/del/id/<?php echo ($val["id"]); ?>">删除</a>|
            <a href="/gzsc/index.php/Admin/User/start/id/<?php echo ($val["id"]); ?>">启用</a>|
            <a href="/gzsc/index.php/Admin/User/shopinfo/id/<?php echo ($val["id"]); ?>">查看</a>
          <?php elseif($val["user_grade"] == 4): ?>
            <a href="/gzsc/index.php/Admin/User/edit/id/<?php echo ($val["id"]); ?>">修改</a>|
            <a href="/gzsc/index.php/Admin/User/del/id/<?php echo ($val["id"]); ?>">删除</a>|
            <a href="/gzsc/index.php/Admin/User/jihuo/id/<?php echo ($val["id"]); ?>">激活</a>|
            <a href="/gzsc/index.php/Admin/User/shopinfo/id/<?php echo ($val["id"]); ?>">查看</a><?php endif; ?>
         </td> 
