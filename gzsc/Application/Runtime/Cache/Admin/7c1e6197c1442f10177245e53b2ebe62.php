...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 商品图片 </button> 
      </div>  

      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Admin/Store/addpic/id/<?php echo ($good_attr_info["id"]); ?>"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-plus"></i>添加图片 </button></a> 
      </div> 

      <div class="btn-group pull-right"> 
       <a href="/gzsc/index.php/Admin/Store/detail/id/<?php echo ($good_attr_info['good_id']); ?>"><button id="editable-sample_new" class="btn btn-primary"><i class="fa fa-reply"></i> fa-reply</button></a> 
      </div>
  ...
  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="" novalidate="novalidate"> 
   
    <?php if(is_array($info)): foreach($info as $key=>$val): ?><div class="panel-body ">
          <div class="media blog-cmnt">
              <a href="" class="pull-left">
                  <img alt="" src="/gzsc/Public/Uploads/<?php echo ($val['file_pic']); ?>" class="media-object">
              </a>
              <div class="media-body">
                  <h4 class="media-heading">
                      <a href="#"><?php echo ($good_attr_info['good_name']); ?></a>
                  </h4>
                  <p class="mp-less">
                    <?php echo ($good_attr_info['good_attr_des']); ?>;
                    <?php if(empty($good_attr_info['good_attr_color']) == true): else: ?>颜色：<?php echo ($good_attr_info['good_attr_color']); ?>;<?php endif; ?>
                    <?php if(empty($good_attr_info['good_attr_size']) == true): else: ?>大小为：<?php echo ($good_attr_info['good_attr_size']); ?>;<?php endif; ?>
                    价格：<?php echo ($good_attr_info['good_attr_price']); ?>;库存量：<?php echo ($good_attr_info['good_attr_num']); ?>;
                  </p>
                  <p style="margin-top:10px;">
                    <a href="/gzsc/index.php/Admin/Store/editpic/id/<?php echo ($val["id"]); ?>">修改</a> | 
                    <a href="/gzsc/index.php/Admin/Store/delpic/id/<?php echo ($val["id"]); ?>">删除</a>  
                  </p>
              </div>
          </div>
