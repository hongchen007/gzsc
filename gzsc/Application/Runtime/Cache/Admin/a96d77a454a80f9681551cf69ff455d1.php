...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 商城公告 </button> 
      </div> 
      <div class="btn-group pull-right"> 
       <a href="<?php echo U('Storenotice/add');?>"><button id="editable-sample_new" class="btn btn-primary"> Add New <i class="fa fa-plus"></i> </button></a> 
     ...
     <div class="panel-body">
        <form class="form-inline" role="form" action="<?php echo U('Storenotice/index');?>" method="get" />
            
            <div class="form-group">
                <input class="form-control" id="exampleInputEmail2" value="<?php echo ($_GET['store_notice_http']); ?>" name="store_notice_http" placeholder="搜索商城公告链接地址" type="text">
            </div>

            <div class="form-group">状态：
              <select class="form-control m-bot15" name="store_notice_state">
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 17%;" aria-label="First Name">商城公告标题</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 17%;" aria-label="Last Name: activate to sort column ascending">商城公告内容</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 17%;" aria-label="Last Name: activate to sort column ascending">商城公告链接</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 17%;" aria-label="Last Name: activate to sort column ascending">状态</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 17%;" aria-label="Points: activate to sort column ascending">添加时间</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 17%;" aria-label="Points: activate to sort column ascending">操作</th>
        </tr> 
       </thead> 
       <tbody role="alert" aria-live="polite" aria-relevant="all"> 
       <?php if(is_array($UserInfo)): foreach($UserInfo as $key=>$val): ?><tr class="odd">   
         <td class=" "><?php echo ($val["title"]); ?></td> 
         <td class=" "><?php echo ($val["content"]); ?></td> 
         <td class=" "><?php echo ($val["store_notice_http"]); ?></td>  
         <td class="  sorting_1">
            <?php if($val["store_notice_state"] == 1): ?><span style="color:blue;"> 正常</span>
            <?php elseif($val["store_notice_state"] == 2): ?> <span style="color:red;">禁用</span><?php endif; ?>
         </td> 
         <td class=" "><?php echo ($val["store_notice_addtime"]); ?></td>
         <td class=" ">
          <?php if($val["store_notice_state"] == 1): ?><a href="/gzsc/index.php/Admin/Storenotice/edit/id/<?php echo ($val["id"]); ?>">修改</a>  | 
            <a href="/gzsc/index.php/Admin/Storenotice/del/id/<?php echo ($val["id"]); ?>">删除</a> | 
            <a href="/gzsc/index.php/Admin/Storenotice/stop/id/<?php echo ($val["id"]); ?>">禁用</a>
          <?php else: ?>
            <a href="/gzsc/index.php/Admin/Storenotice/edit/id/<?php echo ($val["id"]); ?>">修改</a> | 
            <a href="/gzsc/index.php/Admin/Storenotice/del/id/<?php echo ($val["id"]); ?>">删除</a>  |  
            <a href="/gzsc/index.php/Admin/Storenotice/start/id/<?php echo ($val["id"]); ?>">启用</a><?php endif; ?>
         </td> 
