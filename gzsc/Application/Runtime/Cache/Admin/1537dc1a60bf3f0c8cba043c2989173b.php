...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 浏览分类 </button> 
      </div> 
      <div class="btn-group pull-right"> 
       <!-- <a href="<?php echo U('Cate/add');?>"><button id="editable-sample_new" class="btn btn-primary"> Add New <i class="fa fa-plus"></i> </button></a>  -->
...
<!--      <div class="panel-body">
        <form class="form-inline" role="form" action="<?php echo U('Cate/index');?>" method="get" />
            
            <div class="form-group">
                <input class="form-control" id="exampleInputEmail2" value="<?php echo ($_GET['cate_name']); ?>" name="cate_name" placeholder="搜索分类名" type="text">
            </div>
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 5%;" aria-label="First Name">分类ID</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Last Name: activate to sort column ascending">分类名</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Last Name: activate to sort column ascending">父类id</th>
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Points: activate to sort column ascending">Path</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Points: activate to sort column ascending">代表性图片</th>
       ...
       <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr class="odd"> 
         <td class="  sorting_1"><?php echo ($val["id"]); ?></td> 
         <td class=" "><?php echo ($val["cate_name"]); ?></td> 
         <td class=" "><?php echo ($val["cate_pid"]); ?></td> 
         <td class=" "><?php echo ($val["cate_path"]); ?></td> 
          <?php if(empty($val['cate_pic']) == false): ?><td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['cate_pic']); ?>" style="height:40px;"></td> 
          <?php else: ?>
            <td class=" ">无</td><?php endif; ?>
         <td class=" ">
            <a href="/gzsc/index.php/Admin/Cate/edit/id/<?php echo ($val["id"]); ?>">修改</a> 
            <!-- <a href="/gzsc/index.php/Admin/Cate/del/id/<?php echo ($val["id"]); ?>">删除</a> -->
         </td> 
