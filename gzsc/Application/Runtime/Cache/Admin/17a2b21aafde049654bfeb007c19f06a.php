...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 家政服务服务 </button> 
      </div> 
<!--       <div class="btn-group pull-right"> 
     ...
     <div class="panel-body">
        <form class="form-inline" role="form" action="<?php echo U('Service/housekeeping');?>" method="get" />
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd">
         ...
         <td class=" ">
            <?php if($val["states"] == 1): ?><span style="color:green;"> 待审核</span><a href="/gzsc/index.php/Admin/Service/housekeepingpass/id/<?php echo ($val["id"]); ?>">(点击通过审核)</a>
            <?php elseif($val["states"] == 2): ?> <span style="color:blue;">通过审核，正常</span><a href="/gzsc/index.php/Admin/Service/housekeepingstop/id/<?php echo ($val["id"]); ?>">(点击禁用)</a>
            <?php elseif($val["states"] == 3): ?> <span style="color:red;">已禁用</span><a href="/gzsc/index.php/Admin/Service/housekeepingpass/id/<?php echo ($val["id"]); ?>">(点击通过审核)</a><?php endif; ?>
         </td>
         <td class=" ">
            <a href="/gzsc/index.php/Admin/Service/housekeepingedit/id/<?php echo ($val["id"]); ?>">详情</a> <br>
            <a href="/gzsc/index.php/Admin/Service/housekeepingdel/id/<?php echo ($val["id"]); ?>">删除</a> <br> 
            <a href="/gzsc/index.php/Admin/Service/housekeepingfile/id/<?php echo ($val["id"]); ?>">图片</a> <br> 
         </td> 
