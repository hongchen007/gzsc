...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="clearfix" style="margin-left:10px;"> 
    <div class="btn-group"> 
     <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 添加<?php echo ($good_info['good_name']); ?>图片 </button> 
    </div>  
   </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Store/doaddpic');?>" novalidate="novalidate"> 
     ...
     <div class="form-group "> 
      ...
      <div class="col-lg-10"> 
       ...
       <input id="good_attr_id" name="good_attr_id" type="hidden" value="<?php echo ($good_attr_info['id']); ?>" /> 
       <input id="good_id" name="good_id" type="hidden" value="<?php echo ($good_info['id']); ?>" /> 
      </div> 
     </div>
