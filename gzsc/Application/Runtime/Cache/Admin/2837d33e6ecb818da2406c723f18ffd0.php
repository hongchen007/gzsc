    ...
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      ...
      <div class="btn-group pull-right"> 
       <a href="<?php echo U('Pics/add');?>"><button id="editable-sample_new" class="btn btn-primary"> Add New <i class="fa fa-plus"></i> </button></a> 
     ...
     <div class="panel-body">
        <form class="form-inline" role="form" action="<?php echo U('Pics/index');?>" method="get" />
            ...
            <div class="form-group">
                <input class="form-control" id="exampleInputEmail2" value="<?php echo ($_GET['pic_http']); ?>" name="pic_http" placeholder="图片链接地址搜索" type="text">
            </div>
            
            <div class="form-group">
                <input class="form-control" id="exampleInputEmail2" value="<?php echo ($_GET['store_name']); ?>" name="store_name" placeholder="商店名搜索" type="text">
            </div>

            <div class="form-group">是否失效：
              <select class="form-control m-bot15" name="pic_status" >
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 10%;" aria-label="First Name">所属商店</th>
         <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 10%;" aria-label="First Name">图片</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 10%;" aria-label="Last Name: activate to sort column ascending">链接地址</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 10%;" aria-label="Last Name: activate to sort column ascending">图片的位置</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 10%;" aria-label="Last Name: activate to sort column ascending">描述</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 10%;" aria-label="Points: activate to sort column ascending">添加时间</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 10%;" aria-label="Points: activate to sort column ascending">过期时间</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 10%;" aria-label="Points: activate to sort column ascending">是否失效</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 10%;" aria-label="Last Name: activate to sort column ascending">状态</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 10%;" aria-label="Points: activate to sort column ascending">操作</th>
        </tr> 
       </thead> 
       <tbody role="alert" aria-live="polite" aria-relevant="all"> 
       <?php if(is_array($UserInfo)): foreach($UserInfo as $key=>$val): ?><tr class="odd"> 
         <td class=" "><?php echo ($val["user_store_name"]); ?></td>
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['pic']); ?>" style="height:100px;"></td>  
         <td class=" "><?php echo ($val["pic_http"]); ?></td> 
         <td class="  sorting_1">
            <?php if($val["pic_address"] == 1): ?>头部的图片轮播
            <?php elseif($val["pic_address"] == 2): ?>中间的图片轮播<?php endif; ?>
         </td> 
         <td class=" "><?php echo ($val["pic_descr"]); ?></td> 
         <td class=" "><?php echo ($val["pic_add_time"]); ?></td>  
         <td class=" "><?php echo ($val["end_time"]); ?></td>  
         <td class="  sorting_1">
            <?php if($val["pic_status"] == 1): ?><span style="color:blue;"> 正常</span>
            <?php elseif($val["pic_status"] == 2): ?> <span style="color:red;">失效</span><?php endif; ?>
         </td>  
         <td class="  sorting_1">
            <?php if($val["pic_state"] == 1): ?><span style="color:blue;"> 正常</span>
            <?php elseif($val["pic_state"] == 2): ?> <span style="color:red;">禁用</span>
            <?php elseif($val["pic_state"] == 3): ?> <span style="color:green;">待审核<a href="/gzsc/index.php/Admin/Pics/pass/id/<?php echo ($val["id"]); ?>">(点击通过审核)</a></span><?php endif; ?>
         </td> 
         <td class=" ">
          <?php if($val["pic_state"] == 1): ?><a href="/gzsc/index.php/Admin/Pics/detail/id/<?php echo ($val["id"]); ?>">详情</a> <br>
            <a href="/gzsc/index.php/Admin/Pics/edit/id/<?php echo ($val["id"]); ?>">修改</a> <br>
            <a href="/gzsc/index.php/Admin/Pics/del/id/<?php echo ($val["id"]); ?>">删除</a><br>
            <a href="/gzsc/index.php/Admin/Pics/stop/id/<?php echo ($val["id"]); ?>">禁用</a>
          <?php else: ?>
            <a href="/gzsc/index.php/Admin/Pics/detail/id/<?php echo ($val["id"]); ?>">详情</a><br>
            <a href="/gzsc/index.php/Admin/Pics/edit/id/<?php echo ($val["id"]); ?>">修改</a><br>
            <a href="/gzsc/index.php/Admin/Pics/del/id/<?php echo ($val["id"]); ?>">删除</a> <br> 
            <a href="/gzsc/index.php/Admin/Pics/start/id/<?php echo ($val["id"]); ?>">启用</a><?php endif; ?>
         </td> 
