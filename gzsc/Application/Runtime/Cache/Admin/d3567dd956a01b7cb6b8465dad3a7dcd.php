...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 添加商城公告 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Storenotice/insert');?>" novalidate="novalidate"> 
    
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">商城公告标题</label> 
      <div class="col-lg-10"> 
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">商城公告内容</label>
        <div class="col-sm-10">
    ...
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">商城公告链接</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="store_notice_http" name="store_notice_http" type="text" /> 
      </div> 
     </div> 
