...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 个人中心 </button> 
      </div> 
     </div> 
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 5%;" aria-label="First Name">名称</th>
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 5%;" aria-label="Last Name: activate to sort column ascending">头像</th>
       ...
       <?php if(is_array($UserInfo)): foreach($UserInfo as $key=>$val): ?><tr class="odd"> 
         ...
         <td class="  sorting_1">
          <?php if($val["user_grade"] == 0): ?><span style="color:blue;"> 超级管理员</span><?php endif; ?>
          <?php if($val["user_grade"] == 1): ?><span style="color:green;"> 管理员</span><?php endif; ?>
         </td> 
         <td class=" ">
           <?php if(empty($val['user_pic']) == true): ?>没有上传头像
           <?php else: ?>
            <img src="/gzsc/Public/Uploads/<?php echo ($val['user_pic']); ?>" style="width:100px;"><?php endif; ?>
         </td>  
         <td class=" ">
            <a href="/gzsc/index.php/Admin/User/edit_self/id/<?php echo ($val["id"]); ?>">修改</a>
         </td> 
