...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 二手车服务 </button> 
      </div> 
<!--       <div class="btn-group pull-right"> 
     ...
     <div class="panel-body">
        <form class="form-inline" role="form" action="<?php echo U('Service/secondhandcar');?>" method="get" />
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 7%;" aria-label="Last Name: activate to sort column ascending">品牌</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 7%;" aria-label="Last Name: activate to sort column ascending">价格</th>
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 6%;" aria-label="Points: activate to sort column ascending">行驶证照片</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 6%;" aria-label="Points: activate to sort column ascending">车牌照照片</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 6%;" aria-label="Points: activate to sort column ascending">登记照照片</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 6%;" aria-label="Points: activate to sort column ascending">购买发票照片</th>
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd">
        <td class=" "><?php echo ($val["id"]); ?></td>    
         <td class=" ">
            <?php if($val["user_grade"] == 2 || $val["user_grade"] == 3 || $val["user_grade"] == 4): ?><span style="color:green;">商户：<?php echo ($val["user_store_name"]); ?></span>
            <?php elseif($val["user_grade"] == 5 || user_grade == 6): ?> <span style="color:blue;">用户：<?php echo ($val["user_name"]); ?></span><?php endif; ?>
         </td> 
         <td class=" "><?php echo ($val["brank"]); ?></td> 
         <td class=" "><?php echo ($val["price"]); ?>元</td>  
         <td class=" "><?php echo ($val["name"]); ?></td>
         <td class=" "><?php echo ($val["tel"]); ?></td>
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['driving_lience_pic']); ?>" style="height:80px;"></td>
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['lience_num_pic']); ?>" style="height:80px;"></td>
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['register_pic']); ?>" style="height:80px;"></td>
         <td class=" "><img src="/gzsc/Public/Uploads/<?php echo ($val['bill_pic']); ?>" style="height:80px;"></td>
         ...
         <td class=" ">
            <?php if($val["states"] == 1): ?><span style="color:green;"> 待审核</span><a href="/gzsc/index.php/Admin/Service/secondhandcarpass/id/<?php echo ($val["id"]); ?>">(点击通过审核)</a> 
            <?php elseif($val["states"] == 2): ?> <span style="color:blue;">通过审核，正常</span><a href="/gzsc/index.php/Admin/Service/secondhandcarstop/id/<?php echo ($val["id"]); ?>">(点击禁用)</a>
            <?php elseif($val["states"] == 3): ?> <span style="color:red;">已禁用</span><a href="/gzsc/index.php/Admin/Service/secondhandcarpass/id/<?php echo ($val["id"]); ?>">(点击通过审核)</a><?php endif; ?>
         </td>
         <td class=" ">
            <a href="/gzsc/index.php/Admin/Service/secondhandcaredit/id/<?php echo ($val["id"]); ?>">详情</a> <br>
            <a href="/gzsc/index.php/Admin/Service/secondhandcardel/id/<?php echo ($val["id"]); ?>">删除</a> <br> 
            <a href="/gzsc/index.php/Admin/Service/secondhandcarfile/id/<?php echo ($val["id"]); ?>">图片</a> <br> 
         </td> 
