...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 修改电商广告轮播 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Pics/update');?>" novalidate="novalidate"> 
     ...
     <div class="form-group "> 
      ...
      <div class="col-lg-10"> 
        <img src="/gzsc/Public/Uploads/<?php echo ($info["pic"]); ?>">
      </div> 
     </div> 
    ...
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">轮播图连接ID（商品的ID）</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="pic_http" name="pic_http" type="text" value="<?php echo ($info["pic_http"]); ?>" /> 
      </div> 
     </div> 
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
          <div class="radio">
              <label>
                  <input  id="pic_address" type="radio" name="pic_address" value="1" <?php if($info["pic_address"] == 1): ?>checked<?php endif; ?> >
                  头部图片轮播
              </label>
          </div>
          <div class="radio">
              <label>
                  <input  id="pic_address" type="radio" name="pic_address" value="2" <?php if($info["pic_address"] == 2): ?>checked<?php endif; ?> >
                  中部图片轮播
              </label>
          </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea rows="6" class="form-control" name="pic_descr" ><?php echo ($info["pic_descr"]); ?></textarea>
        </div>
    </div>
