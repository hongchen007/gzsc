...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 电商广告添加 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Pics/insert');?>" novalidate="novalidate"> 
    ...
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">广告图片连接ID（商品的ID）</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="pic_http" name="pic_http" type="text" /> 
      </div> 
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
          <div class="radio">
              <label>
                  <input  id="pic_address"  checked type="radio" name="pic_address" value="1">
                  头部图片轮播
              </label>
          </div>
          <div class="radio">
              <label>
                  <input  id="pic_address" type="radio" name="pic_address" value="2">
                  中部图片轮播
              </label>
          </div>
      </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea rows="6" class="form-control" name="pic_descr"></textarea>
        </div>
    </div>
