...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 修改电商广告 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Adsserve/update');?>" novalidate="novalidate"> 
    
     <div class="form-group "> 
      <label for="state" class="control-label col-lg-2">修改图片</label> 
      <div class="col-lg-10"> 
       <input id="pic" name="pic" type="file" onChange="document.getElementsByName('xgpic')[0].value=this.value" /> 
     ...
     <div class="form-group "> 
      <label for="state" class="control-label col-lg-2" >原图片</label> 
      <div class="col-lg-10"> 
        <img src="/gzsc/Public/Uploads/<?php echo ($info["adsserve_pic"]); ?>" style="height:300px;">
      </div> 
     </div> 
    ...
    <div class="form-group "> 
      ...
      <div class="form-group">
          <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">修改服务类型</label>
          <div class="col-lg-10"> 
              <select class="form-control m-bot15" name="adsserve_pic1" id="adsserve_pic1">   
                  <?php if(is_array($cateinfo)): foreach($cateinfo as $key=>$val): ?><option value="<?php echo ($val["id"]); ?>" <?php if($info['cate_id'] == $val['id'] ): ?>selected<?php endif; ?>><?php echo ($val["cate_name"]); ?></option><?php endforeach; endif; ?>
              </select>
          </div>
      </div>
    ...
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">轮播图连接ID（所属服务ID）</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="adsserve_http" name="adsserve_http" type="text" value="<?php echo ($info["adsserve_http"]); ?>" /> 
      </div> 
     </div> 

    <div class="form-group">
      <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">图片的位置</label>
      <div class="col-lg-10">
          <div class="radio">
              <label>
                  <input  id="adsserve_address" type="radio" name="adsserve_address" value="1" <?php if($info["adsserve_address"] == 1): ?>checked<?php endif; ?> >
                  头部图片轮播
              </label>
          </div>
          <div class="radio">
              <label>
                  <input  id="adsserve_address" type="radio" name="adsserve_address" value="2" <?php if($info["adsserve_address"] == 2): ?>checked<?php endif; ?> >
                  中部图片轮播
              </label>
          </div>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">轮播图描述</label>
        <div class="col-sm-10">
            <textarea rows="6" class="form-control" name="adsserve_descr" ><?php echo ($info["adsserve_descr"]); ?></textarea>
        </div>
    </div>
