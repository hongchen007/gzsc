     ...
     <div id="editable-sample_wrapper" class="dataTables_wrapper form-inline" role="grid">
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd"> 
         ...
         <td class=" ">
            <a href="/gzsc/index.php/Admin/Store/editattr/good_attr_id/<?php echo ($val["id"]); ?>">修改</a> | 
            <a href="/gzsc/index.php/Admin/Store/delattr/good_attr_id/<?php echo ($val["id"]); ?>">删除</a> |
            <a href="/gzsc/index.php/Admin/Store/pic/good_attr_id/<?php echo ($val["id"]); ?>">图片</a> 
         </td> 
