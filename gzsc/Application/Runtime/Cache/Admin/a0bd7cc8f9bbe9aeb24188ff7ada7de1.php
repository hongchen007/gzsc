...
<head>
  ...
  <link rel="shortcut icon" href="#" type="image/png">
   ...
   <title>后台-修改<?php echo ($info["cate_name"]); ?>分类图片</title>
...
<!--        <form class="searchform" action="index.html" method="post">
 ...
 <div class="clearfix" style="margin-left:10px;"> 
  <div class="btn-group"> 
   <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 修改<?php echo ($info["cate_name"]); ?>分类图片 </button> 
  </div>  
 </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Cate/update');?>" novalidate="novalidate"> 

     <div class="form-group "> 
      <label for="state" class="control-label col-lg-2">修改图片</label> 
      <div class="col-lg-10"> 
       <input id="pic" name="cate_pic" type="file" onChange="document.getElementsByName('xgpic')[0].value=this.value" /> 
       <input type="hidden" name="xgpic">
       <input type="hidden" name="id" value="<?php echo ($info['id']); ?>">
      </div> 
     </div> 
    
    <?php if(empty($info['cate_pic']) == false): ?><div class="form-group "> 
      <label for="state" class="control-label col-lg-2" >原图片</label> 
      <div class="col-lg-10"> 
        <img src="/gzsc/Public/Uploads/<?php echo ($info["cate_pic"]); ?>" style="width:70%">
      </div> 
     </div> 
    ...
    <?php else: ?>
     ...
     <div class="form-group "> 
      <label for="state" class="control-label col-lg-2" style="width:70%" >原图片</label> 
      <div class="col-lg-10"> 
        无
      </div> 
     </div><?php endif; ?>
...
<!--     <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">修改分类名</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="cate_name" name="cate_name" type="text" value="<?php echo ($info["cate_name"]); ?>" /> 
      </div> 
     </div> -->
