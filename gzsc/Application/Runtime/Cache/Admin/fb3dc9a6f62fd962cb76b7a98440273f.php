...
<!--        <form class="searchform" action="index.html" method="post">
   ...
   <div class="panel-body"> 
    <div class="adv-table editable-table "> 
     ...
     <div class="clearfix"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 招聘信息服务 </button> 
      </div> 
<!--       <div class="btn-group pull-right"> 
     ...
     <div class="panel-body">
        <form class="form-inline" role="form" action="<?php echo U('Service/inforservice');?>" method="get" />
      ...
      <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info"> 
       <thead>
        <tr role="row">
         ...
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 7%;" aria-label="Last Name: activate to sort column ascending">公司地址</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 7%;" aria-label="Points: activate to sort column ascending">招聘职位</th>
         <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" style="width: 7%;" aria-label="Points: activate to sort column ascending">薪酬</th>
       ...
       <?php if(is_array($info)): foreach($info as $key=>$val): ?><tr class="odd">  
        <td class=" "><?php echo ($val["id"]); ?></td> 
         ...
         <td class=" "><?php echo ($val["seat"]); ?></td> 
         <td class=" "><?php echo ($val["payment"]); ?></td> 
         ...
         <td class=" ">
            <?php if($val["states"] == 1): ?><span style="color:green;"> 待审核</span><a href="/gzsc/index.php/Admin/Service/informationpass/id/<?php echo ($val["id"]); ?>">(点击通过审核)</a>
            <?php elseif($val["states"] == 2): ?> <span style="color:blue;">通过审核，正常</span><a href="/gzsc/index.php/Admin/Service/informationstop/id/<?php echo ($val["id"]); ?>">(点击禁用)</a>
            <?php elseif($val["states"] == 3): ?> <span style="color:red;">已禁用</span><a href="/gzsc/index.php/Admin/Service/informationpass/id/<?php echo ($val["id"]); ?>">(点击通过审核)</a><?php endif; ?>
         </td>
         <td class=" ">
            <a href="/gzsc/index.php/Admin/Service/inforserviceedit/id/<?php echo ($val["id"]); ?>">详情</a> <br>
            <a href="/gzsc/index.php/Admin/Service/inforservicedel/id/<?php echo ($val["id"]); ?>">删除</a> <br> 
            <a href="/gzsc/index.php/Admin/Service/inforservicefile/id/<?php echo ($val["id"]); ?>">图片</a> <br> 
         </td> 
