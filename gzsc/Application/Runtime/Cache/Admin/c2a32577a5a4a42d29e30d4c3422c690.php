...
<!--        <form class="searchform" action="index.html" method="post">
  ...
  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Service/companydoedit');?>" novalidate="novalidate">   

    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">公司工厂名称</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="company_name" name="company_name" type="text" value="<?php echo ($info["company_name"]); ?>" /> 
       <input class="form-control " id="id" name="id" type="hidden" value="<?php echo ($info["id"]); ?>" /> 
      </div> 
     </div> 

    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">公司工厂简介</label> 
      <div class="col-lg-10"> 
       <textarea rows="6" class="form-control" name="company_des" ><?php echo ($info["company_des"]); ?></textarea>
      </div> 
     </div> 

    <div class="form-group">
        <label class="col-sm-2 control-label">公司工厂地址</label>
        <div class="col-sm-10">
            <textarea rows="6" class="form-control" name="address" ><?php echo ($info["address"]); ?></textarea>
        </div>
    </div>

    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">公司工厂注册时间</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="register_time" name="register_time" type="text" value="<?php echo ($info["register_time"]); ?>" /> 
      </div> 
     </div> 

<!--     <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">修改公司工厂注册时间</label> 
      <div class="col-lg-10">
    ...
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">主要经营</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="contents" name="contents" type="text" value="<?php echo ($info["contents"]); ?>" /> 
      </div> 
     </div> 

    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">法人</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="legal_person" name="legal_person" type="text" value="<?php echo ($info["legal_person"]); ?>" /> 
      </div> 
     </div> 

    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">手机号</label> 
      <div class="col-lg-10"> 
 ...
 <!--    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">截止日期</label> 
      <div class="col-lg-10"> 
       <input class="form-control " id="tel" name="tel" type="text" value="<?php echo ($info["valid_time"]); ?>" /> 
      </div> 
     </div>  -->
