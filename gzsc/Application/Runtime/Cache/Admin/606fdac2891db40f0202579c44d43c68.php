...
<!--        <form class="searchform" action="index.html" method="post">
     ...
     <div class="clearfix" style="margin-left:10px;"> 
      <div class="btn-group"> 
       <button id="editable-sample_new" class="btn btn-primary"> 后台 &gt; 添加服务信息 </button> 
      </div>  
     </div> 

  <div class="panel-body"> 
   <div class="form"> 
    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" enctype="multipart/form-data" action="<?php echo U('Service/doadd');?>" novalidate="novalidate"> 
    
    <div class="form-group "> 
      <label for="QQ" class="control-label col-lg-2">商品类别</label> 
      <div class="col-lg-10"> 
        <select class="form-control m-bot15" name="good_cate">
          <?php if(is_array($info)): foreach($info as $key=>$row): ?><option value="<?php echo ($row['id']); ?>"><?php echo ($row['cate_name']); ?></option><?php endforeach; endif; ?>
        </select>
      </div> 
     </div>  
